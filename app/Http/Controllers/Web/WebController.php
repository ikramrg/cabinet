...
class WebController extends AppBaseController
{
    ...
    public function index()
    {
        ...
        return view('web.home.index',
            compact('doctorsDepartments', 'doctors', 'todayNotice', 'testimonials',
                'totalDoctor', 'totalPatient', 'doctorAppointments', 'frontSetting', 'frontServices'));
    }
    ...
    public function aboutUs()
    {
        ...
        return view('web.home.about_us',
            compact('frontSetting', 'totalDoctor', 'totalPatient', 'testimonials', 'doctors'));
    }
